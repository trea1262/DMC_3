...
class FrozenInTime(BaseModel):
    def __init__(self,
        ...
        if self.text_params['model'].startswith('roberta'):
            #self.text_model = RobertaModel.from_pretrained("/data/zoujy/EgoVideoQA/pretrain_model/roberta-base", local_files_only=True)
    ...
    def forward(self, data, video_only=False, return_embeds=True):
        ...
        text_embed,text_embeds = self.text_model.encode_text(text_data['input_ids']) 
