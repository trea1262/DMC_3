...
from dataset import EgoTaskQA, collate_func
...
def parse_args():
    ...
    parser.add_argument('--resume_finetune_model_path', type=str, default='...',help ="Path of the previously fine-tuned checkpoint for resume")
...
def main_worker(gpu, args):
    ...
    f = open('.../EgoTaskQA/configs/egotaskqa.json')
    config = json.load(f)
